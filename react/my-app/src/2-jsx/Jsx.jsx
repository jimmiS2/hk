...
// JSX 문법
export const E1 = <h1 className="gretting">Hello JSX!</h1>;
...
export const E4 = React.createElement(
  ...
  React.createElement("p", null, "This is is simple Text.")
);

// 조건부 렌더링
const isLoggIn = false;
export const E5 = (
  <div>{isLoggIn ? <h1> Welcome! </h1> : <h1> Plz SignIn</h1>}</div>
);
...
export const E6 = React.createElement(
  ...
  null,
  isLoggIn
    ? React.createElement("h1", null, "welcome JSX!")
